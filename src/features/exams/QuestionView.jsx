...
export function QuestionView({ exam, onBack, userName }) {
    ...
    const handleDownloadResults = () => {
        ...
        questions.forEach((q, index) => {
            ...
            const selectedText = answer.selectedText ? ` (${answer.selectedText})` : '';
            const correctText = answer.correctText ? ` (${answer.correctText})` : '';

            content += `| ${index + 1} | ${safeText} | **${answer.selected.toUpperCase()}**${selectedText} | ${q.correctAnswer.toUpperCase()}${correctText} | ${resultIcon} |\n`;
        });
                                    ...
                                    >
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="text-sm text-slate-400 space-y-1">
                                                <div>
                                                    Your answer: <span className={answer.isCorrect ? "text-emerald-400 font-medium" : "text-red-400 font-medium"}>
